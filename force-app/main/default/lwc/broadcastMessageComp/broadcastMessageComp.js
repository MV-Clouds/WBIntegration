        ...
        fetchGroupDetails() {
            ...
            getBroadcastGroupDetails({ groupId: this.broadcastGroupId })
                .then((result) => {
                    ...
                    this.selectedObject = groupData.isMarketingCampaignSelectedObject_Name__c || '';  // Set Object Name
                    this.loadListViews();
                    this.selectedListView = groupData.isMarketingCampaignSelectedList_View__c || '';  // Set List View Name


                    this.broadcastGroupName = groupData.Name;
                    this.messageText = groupData.isMarketingCampaignSelectedDescription__c;
            ...
            .then(result => {
                ...
                if (result) {
                    ...
                    if (this.isIntialRender && this.broadcastGroupId && this.groupMembers.length > 0) {
                        ...
                        const memberPhoneNumbers = new Set(this.groupMembers.map(member => member.isMarketingCampaignSelectedPhone_Number__c));
