...
import WBCChatBG from '@salesforce/resourceUrl/WBI_chat_bg';
    ...
    handleSubscribe() {
        try {
            ...
            let messageCallback = function (response) {
                ...
                if(response.data.payload.MVWB__Phone__c !== self.phoneNumber) return;
                ...
                if(actionType!='new') self.processChats(true);
                self.getChatsForSelectedObject(false);
            };
